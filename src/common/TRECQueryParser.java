...
//            .replaceAll("\\?", " ").replaceAll("\"", " ").replaceAll("\\&", " "), fieldToSearch);
        ...
        return new TermQuery(new Term(fieldToSearch, queryString));
    }
    ...
    public static void main(String[] args) {
        ...
        if (args.length != 2) {
            args = new String[1];
            System.err.println("usage: java TRECQuery <.properties> <input xml file>");
        ...
        try {
            ...
            TRECQueryParser queryParser = new TRECQueryParser(args[1], analyzer, fieldToSearch);
            ...
            for (TRECQuery query : queryParser.queries) {
                ...
                System.out.println(query.queryFieldAnalyze(analyzer, query.qtitle, fieldToSearch));    // this statement analyze the query text as simple text
            }
